...
export const KioskGuideModal: React.FC<KioskGuideModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-slate-900/70 pt-safe pb-safe">
      <div className="bg-white rounded-3xl max-w-2xl w-full p-5 sm:p-8 shadow-2xl border border-slate-200 max-h-[calc(100dvh-2rem)] overflow-y-auto my-auto">
        ...
        <div className="flex items-center justify-between pb-4 border-b border-slate-100">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-lg sm:text-xl font-extrabold text-slate-900">Guia de Instalação (iPad & iPhone)</h3>
              <p className="text-xs text-slate-500">Como instalar como PWA e travar em modo Totem</p>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="space-y-6 mt-6">
          ...
          <div className="bg-slate-50 rounded-2xl p-5 border border-slate-200">
            ...
            <ol className="space-y-2 text-xs text-slate-700 pl-2">
              ...
              <li className="flex items-center gap-2">
                <PlusSquare className="w-4 h-4 text-blue-600 flex-shrink-0" />
          ...
          <div className="bg-blue-50/70 rounded-2xl p-5 border border-blue-200">
            <div className="flex items-center gap-2.5 font-bold text-blue-700 text-sm mb-2">
